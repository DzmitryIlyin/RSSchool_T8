...
@implementation LandscapeCALayer
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        [self prepareColors];
        _layer1 = [self createSublayer:[LandscapeShape getPath1]];
        [self addSublayer:_layer1];
        _layer2 = [self createSublayer:[LandscapeShape getPath2]];
        [self addSublayer:_layer2];
        _layer3 = [self createSublayer:[LandscapeShape getPath3]];
